...
<div class="container-fluid mt-3">
    <div class="row">
        <a class="btn btn-icon btn-3 btn-success" type="button" href="{{ route('alert.add') }}">
            <span class="btn-inner--icon"><i class="fas fa-plus"></i></span>
            <span class="btn-inner--text">Добавить оповещатель</span>
        </a>
    </div>
    <div class="row">
        <div class="table-responsive">
            ...
            <thead class="thead-light">
                <tr>
                  ...
                  <th scope="col" class="border-0">Мощность</th>
                  <th scope="col" class="border-0"></th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr data-id="{{ $item->id }}">
                    ...
                    <td>
                        ...
                        <a href="{{ route('alert.edit', ['id'=>$item->id]) }}" class="btn" data-toggle="tooltip" data-placement="top" title="Редактировать"><i class="fas fa-edit text-warning"></i></a>
