        ...
        <form action="{{ route('devices.update',['id'=>$item->id]) }}" method="POST" class="col-md-6 col-md-offset-3" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col">
                    ...
                    <input id="wires_count" name="wires_count" type="number" class="form-control" placeholder="0" value="{{ $item->wires_count }}">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col">
                    ...
                    <a href="{{ $item->url }}" target="_blank">{{$item->instruction}}</a>
