...
<div class="container-fluid mt-3">
    <div class="row">
        <a class="btn btn-icon btn-3 btn-success" type="button" href="{{ route('antennas.add') }}">
            <span class="btn-inner--icon"><i class="fas fa-plus"></i></span>
            <span class="btn-inner--text">Добавить антенну</span>
        </a>
    </div>
    <div class="row">
            ...
            <tbody>
                ...
                <tr data-id="{{ $item->id }}">
                    ...
                    <td>
                        ...
                        <a href="{{ route('antennas.edit', ['id'=>$item->id]) }}" class="btn" data-toggle="tooltip" data-placement="top" title="Редактировать"><i class="fas fa-edit text-warning"></i></a>
