...
class Sensors extends Migration
{
    ...
    public function up()
    {
        Schema::create('sensors', function (Blueprint $table) {
            ...
            $table->bool('standalon_smoke_is_radioisotop')->nullable();//По принципу обнаружения пожара автономные дымовые пожарные извещатели разделяют на два типа: автономные пожарные извещатели оптико-электронные, автономные пожарные извещатели радиоизотопные
